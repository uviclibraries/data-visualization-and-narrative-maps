...
This worksheet outlines how to edit two image files in Google Sheets so they can be used most effectively in Juxtapose. The example can be viewed [here](https://goo.gl/KTswQq){:target="_blank"}
...
11. 11.	Finally, upload the two images to Flickr or Dropbox, making sure to check and adjust the privacy settings so that they are publicly available. You will need a URL for each image to create the Juxtapose slider.
