...
1. <img src="images/timeline-make.png" style="float:right;width:300px" alt="TimeLine JS Make Button">Go to the [Make a TimeLine JS](https://timeline.knightlab.com/) and click on the **Make a Timeline** button.
