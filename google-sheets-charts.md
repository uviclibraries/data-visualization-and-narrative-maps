...
1. Open [Google Drive](https://drive.google.com/){:target="_blank"} and make sure that you are logged in.<img src="images/sheets-02.png" style="float:right;width:250px" alt="data example">
...
- Next click on the “**Insert**” menu, and then, “**Chart**”. <img src="images/sheets-03.png" style="float:right;width:200px" alt="bar graph example">
...
3. **Bar Graph with two columns of data**: <img src="images/sheets-04.png" style="float:right;width:300px" alt="data example">
...
- Next click on the “**Insert**” menu, and then, “**Chart**”. <img src="images/sheets-06.png" style="float:right;width:250px" alt="bar graph">
...
4. Pie Chart: <img src="images/sheets-07.png" style="float:right;width:200px" alt="pie charts">
...
- Now let’s change this bar chart into a nice looking Pie Chart. Look on the right navigation bar that just appeared, and click on the little triangle to the right of the “Column chart” and then select the pie chart with the hole in the middle. <img src="images/sheets-08.png" style="float:right;width:250px" alt="revenue vs show pie chart">
...
![Adding Size](images/sheets-10.png)
...
![Bubble Chart example](images/sheets-11.png)
Great job!
