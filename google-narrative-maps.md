...
<img src="images/narrative-01.png" style="float:right;width:160px" alt="projects button and menu">
**Creating Your Google Earth Project** 
1. Go to [Google Earth](https://earth.google.com/web/){:target="_blank"}, click on the menu icon on the left <img src="images/narrative-02.png" style="float:right;width:160px" alt="new project button">
